        ...
        <div className="relative flex flex-col my-5 overflow-hidden">
          <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl px-10">
            ...
            <form>
              ...
              <div className="mt-6">
                <button className="w-full px-4 py-2 tracking-wide text-white transition-all duration-500 transform bg-black rounded-md hover:bg-gray-800 focus:outline-none focus:bg-gray-500">
                  Login
                </button>
              </div>
            </form>
