    ...
    <>
      <div className="flex flex-col justify-center items-center gap-y-4 mt-10 py-14 bg-[#f3f4f6] max-md:p-10 max-md:text-center">
        ...
        <div className="flex gap-5">
          <button className="font-semibold border rounded-md max-md:w-32 max-lg:w-40 max-lg:h-10 w-56 h-12 bg-black text-white hover:bg-white hover:text-black transition-all mb-4 duration-300">
            SHOP MEN
          </button>
          <button className="font-semibold border rounded-md max-md:w-32 max-lg:w-40 max-lg:h-10 w-56 h-12 bg-black text-white hover:bg-white hover:text-black transition-all mb-4 duration-300">
            SHOP WOMEN
