        ...
        <div>
          <div className="container flex flex-wrap mx-auto justify-center">
            {newArrivalData.map((item) => {
              return (
                <div
                  className="item m-3 text-center border border-gray-200"
                  key={item.id}
                >
                  <div className="object-cover w-72 max-md:w-44 max-sm:w-36 border border-gray-200">
                  ...
                  <div className="flex flex-col justify-center relative">
                    <Link to={`/cart/${item.id}?type=newarrival`}>
